...
case_id = ['wobirdy_bird_ai_album_by_image_01']
TestData = GetTestCase.case_data(case_id)
re_data = regular(str(TestData))

@allure.epic("WObird")
@allure.feature("我的收藏-云相册")
class TestBirdAiAlbumByImage:
...
if __name__ == '__main__':
    pytest.main(['test_bird_ai_album_by_image.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
