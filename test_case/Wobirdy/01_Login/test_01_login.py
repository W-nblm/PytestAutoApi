...
@allure.epic("01_Login")
@allure.feature("01_Login")
class Test_01_login:
...
if __name__ == '__main__':
    pytest.main(['d:\PytestAutoApi\test_case\Wobirdy\01_Login\test_01_login.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
