...
case_id = ['wobirdy_query_bird_capture_wiki_01']
TestData = GetTestCase.case_data(case_id)
re_data = regular(str(TestData))

@allure.epic("WObird")
@allure.feature("鸟类首页")
class TestQueryBirdCaptureWiki:
...
if __name__ == '__main__':
    pytest.main(['test_query_bird_capture_wiki.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
