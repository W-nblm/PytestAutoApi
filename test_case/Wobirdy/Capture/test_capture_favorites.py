...
case_id = ['wobirdy_capture_favorites_01']
TestData = GetTestCase.case_data(case_id)
re_data = regular(str(TestData))

@allure.epic("WObird")
@allure.feature("鸟类首页")
class TestCaptureFavorites:
...
if __name__ == '__main__':
    pytest.main(['test_capture_favorites.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
