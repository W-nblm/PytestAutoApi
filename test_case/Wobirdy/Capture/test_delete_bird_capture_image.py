...
case_id = ['wobirdy_delete_bird_capture_image_01']
TestData = GetTestCase.case_data(case_id)
re_data = regular(str(TestData))

@allure.epic("WObird")
@allure.feature("鸟类首页")
class TestDeleteBirdCaptureImage:
...
if __name__ == '__main__':
    pytest.main(['test_delete_bird_capture_image.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
