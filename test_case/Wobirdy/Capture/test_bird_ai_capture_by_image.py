...
case_id = ['wobirdy_bird_ai_capture_by_image_01']
TestData = GetTestCase.case_data(case_id)
re_data = regular(str(TestData))

@allure.epic("WObird")
@allure.feature("鸟类首页")
class TestBirdAiCaptureByImage:
...
if __name__ == '__main__':
    pytest.main(['test_bird_ai_capture_by_image.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
