...
class Test_Common:
    ...
    def test_common_upload_img(self, in_data, case_skip):
        allure.dynamic.title(f"common_upload_img"+"_"+in_data["detail"])
...
if __name__ == '__main__':
    pytest.main(['d:\PytestAutoApi\test_case\Wobirdy\Common\test_common.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
