...
case_id = ['banner_cancel_publish_01']
TestData = GetTestCase.case_data(case_id)
re_data = regular(str(TestData))

@allure.epic("开发平台接口")
@allure.feature("banner接口")
class TestBannerCancelPublish:
...
if __name__ == '__main__':
    pytest.main(['test_banner_cancel_publish.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
