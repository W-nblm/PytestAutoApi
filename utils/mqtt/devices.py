...
class DeviceModle:
    ...
    def event_up(self, device_id="wyl123111", userId=""):
        ...
        from protobuf_py import generalBuffData_pb2
        from protobuf_py import devEventUp_pb2
        from protobuf_py import modelType_pb2
    ...
    def device_activation(
        ...
        temestmp = str(int(time.time() * 1000))
        pus_topic = f"device/network/devices/{device_id}/send/requestId={temestmp}"
        ...
        from protobuf_py import assignNet_pb2
    ...
    def unbind_device(self, device_id="wyl123111"):
        ...
        # 生成protobuf消息
        from protobuf_py import unbindUser_pb2
        from protobuf_py import generalBuffData_pb2
        ...
        def unbind_device_message(client, userdata, msg):
            ...
            logger.info(f"proto_data:\n{respone_data}")
            logger.info(f"buff_data:\n{respone_buff}")
    ...
    def alarm_event_up(self, device_id="wyl123111"):
        ...
        logger.info(f"alarm_request_buff:\n{alarm_request_buff}")
        # buf数据系列化
    ...
    def shadow_device(self, device_id="wyl123111"):
        ...
        # 初始化buff消息
        from protobuf_py import shadowProSet_pb2
