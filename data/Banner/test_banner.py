...
if __name__ == '__main__':
    pytest.main(['d:\PytestAutoApi\data\Banner\test_banner.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
